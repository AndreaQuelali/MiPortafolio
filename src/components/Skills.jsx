  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Next.js", level: 70, color: "from-gray-800 to-gray-600" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Supabase", level: 80, color: "from-green-600 to-green-700" },
      ],
    },
    {
      key: "design",
      ...
      skills: [
        ...
        { name: "Jira", level: 80, color: "from-blue-600 to-blue-500" },
        { name: "Trello", level: 80, color: "from-blue-500 to-blue-600" },
        { name: "Notion", level: 80, color: "from-gray-600 to-gray-500" },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Tecnologías, frameworks y herramientas que domino para crear
            soluciones web modernas y aplicaciones robustas
          </p>
        </motion.div>
